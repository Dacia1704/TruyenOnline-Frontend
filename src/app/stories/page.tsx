...
const statusConfig: Record<string, { text: string; className: string }> = {
  ...
  DROPPED: { text: "Bỏ dở", className: "bg-rose-500/20 text-rose-400" },
};
...
function StoriesContent() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      <p className="mt-2 text-muted-foreground">Khám phá hàng ngàn truyện hay từ cộng đồng.</p>
      ...
      {totalElements > 0 && (
        <p className="mt-6 text-sm text-muted-foreground">Tìm thấy {totalElements.toLocaleString()} truyện</p>
      )}
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">{story.viewCount?.toLocaleString() ?? 0} view</span>
                </div>
              </div>
            </Link>
          ))}
      ...
      {!loading && stories.length === 0 && (
        <div className="mt-16 text-center">
          ...
          {hasActiveFilters && (
            <button onClick={clearFilters} className="mt-4 text-indigo-400 hover:underline">
              ...
              p === "..." ? (
                ...
                <button
                  ...
                  className={`min-w-[40px] rounded-lg px-3 py-2 text-sm font-medium transition ${
                    p === page ? "bg-indigo-600 text-white" : "border border-border hover:bg-muted text-foreground"
                  }`}
                >
                  {p}
                </button>
...
function LoadingFallback() {
  return (
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      <div className="mt-2 h-5 bg-muted animate-pulse rounded w-1/2" />
      <div className="mt-8 h-12 bg-muted animate-pulse rounded" />
