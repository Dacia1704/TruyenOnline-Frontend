...
import { getChapter, getChaptersBySlug, createOrUpdateReadingHistory, getComments, createComment, getBookmark, createBookmark, deleteBookmark } from "@/lib/api/stories";
          ...
          <div className="px-4 py-4">
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button className="text-red-500 hover:text-red-600 transition" title="Danh sách chương" onClick={() => setShowChaptersModal(true)}>
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill={bookmark ? "currentColor" : "none"} stroke="currentColor" strokeWidth={2}>
